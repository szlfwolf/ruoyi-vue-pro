  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="客户地址" prop="clientAddress">
        <el-input v-model="queryParams.clientAddress" placeholder="请输入客户地址" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="客户类型" align="center" prop="clientType">
        <template slot-scope="scope">
          <dict-tag :type="DICT_TYPE.HRSYS_CLIENT_TYPE" :value="scope.row.clientType" />
        </template>
      </el-table-column>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="客户类型" prop="clientType">
          <el-select v-model="form.clientType" placeholder="请选择客户类型">
            <el-option v-for="dict in this.getDictDatas(DICT_TYPE.HRSYS_CLIENT_TYPE)" :key="dict.value" :label="dict.label" :value="parseInt(dict.value)"/>
          </el-select>
        </el-form-item>
        <el-form-item label="客户名称" prop="clientName">
...
<script>
import { createClient, updateClient, deleteClient, getClient, getClientPage, exportClientExcel } from "@/api/hrsys/client";
